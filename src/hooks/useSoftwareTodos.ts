...
// ---------------------------------------------------------------------------
// useSoftwareTodos — fetches the entire software catalogue (ordered by nombre).
// Backs the Catálogo grid view and aggregate counts. Canonical 4-action reducer.
...
export function useSoftwareTodos(): {
  data: Software[]
  loading: boolean
  error: Error | null
  refetch: () => void
